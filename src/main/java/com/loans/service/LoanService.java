...
//        Loan application = new Loan(); POVILAI
//        application.getId();
//        application.setUniqueLoanId();
//        application.setAmount(loanRequest.getLoan_Amount());
...
//        application.setPayDay(loanRequest.getLoan_Payday());
...
//    public void editDraft(Loan loan, LoanRequest loanRequest){ POVILAI
//        Loan application = loan;
//        boolean change = false;
//        if (application.getAmount()!=loanRequest.getLoan_Amount()){
//            application.setAmount(loanRequest.getLoan_Amount());
//            change = true;
//        }
...
//            change = true;
//        }
//        if (application.getPayDay()!=loanRequest.getLoan_Payday()){
//            application.setPayDay(loanRequest.getLoan_Payday());
//            change = true;
//        }
